...
const AppointmentDetails = sequelize.define('appointmentDetails', {
    appointment_ID: {
        type: DataTypes.STRING(50),
        primaryKey: true,
    },
...
const Doctor_schedule_table = sequelize.define('doctor_schedule_table', {
    ...
    doctor_schedule_queueing_number: {
        type: DataTypes.INTEGER
    },
...
Doctor_schedule_table.hasOne(AppointmentDetails, { foreignKey: 'doctor_schedule_ID' })
AppointmentDetails.belongsTo(Doctor_schedule_table, { foreignKey: 'doctor_schedule_ID' })
Doctor_specialization.hasMany(Doctor)
Doctor.belongsTo(Doctor_specialization)

//Junction table
Doctor.belongsToMany(Doctor_department, { through: 'doctor_department_JunctionTable' })
Doctor_department.belongsToMany(Doctor, { through: 'doctor_department_JunctionTable' })
